...
epicsShareExtern rset *pvar_rset_snmpRSET;
epicsShareExtern int (*pvar_func_snmpRecordSizeOffset)(dbRecordType *pdbRecordType);
epicsShareExtern rset *pvar_rset_snmpstrRSET;
epicsShareExtern int (*pvar_func_snmpstrRecordSizeOffset)(dbRecordType *pdbRecordType);
...
static const recordTypeLocation rtl[30] = {
    ...
    {pvar_rset_snmpRSET, pvar_func_snmpRecordSizeOffset},
    {pvar_rset_snmpstrRSET, pvar_func_snmpstrRecordSizeOffset}
};
...
epicsShareExtern dset *pvar_dset_devSNMPRead;
epicsShareExtern dset *pvar_dset_devSNMPWrite;
epicsShareExtern dset *pvar_dset_devSNMPRead_str;
...
static const dset * const devsl[43] = {
    ...
    pvar_dset_devSASoft,
    pvar_dset_devWfSoft,
    pvar_dset_devSNMPRead,
    pvar_dset_devSNMPWrite,
    pvar_dset_devSNMPRead_str
};
...
{
    const char *bldTop = "/home/mijoy0909/epics/R3.14.12.5/RAON_snmp";
